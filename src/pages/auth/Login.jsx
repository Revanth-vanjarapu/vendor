...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // existing key (used by auth guards / axios)
      localStorage.setItem("token", token);

      // new standardized keys (used by sidebar / branding)
      localStorage.setItem("shippzi_token", token);
      localStorage.setItem("shippzi_vendor", JSON.stringify(vendor));

      // optional backward compatibility (if used elsewhere)
